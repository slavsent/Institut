...
urlpatterns = [
    ...
    path("cardstudent/<str:pk>/update", views.CardStudentUpdateView.as_view(), name="cardstudents_update"),
    ...
    path("terms/<str:pk>/detail", views.TermsDetailView.as_view(), name="terms_detail"),
    path("terms/<str:pk>/delete", views.TermsDeleteView.as_view(), name="terms_delete"),
    path("termcourses/", views.TermCoursesListView.as_view(), name="termcourses"),
    path("termcourses/<str:pk>/detail", views.TermCoursesDetailView.as_view(), name="termcourses_detail"),
    path("termcourses/<str:pk>/delete", views.TermCoursesDeleteView.as_view(), name="termcourses_delete"),
